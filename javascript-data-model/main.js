...
var orderHistory = [
  ...
  },
  {
    ...
    title: { order1: 'GameCube Controller - Super Smash Bros. Edition (Nintendo Switch)', order2: 'The Art of Sql' },
    author: { order1: null, order2: 'Faroult, Stephane' },
    orderDate: 'July 3, 2020',
    deliveryDate: 'July 5, 2020',
    retailPrice: { order1: 94.95, order2: 33.99 },
    totalPrice: 138.93,
    shipTo: 'JS Masher',
